  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Learn about Supply & Demand Worldwide Ltd and BorgaFoods, a Ghanaian food manufacturer and export partner serving international B2B buyers."
      ...
      <section className="py-16 bg-gradient-to-br from-primary/5 to-background border-b border-border">
        <div className="container">
          <h1 className="text-5xl font-bold text-foreground mb-4">
            About Supply & Demand Worldwide Ltd
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl">
            Professional export solutions connecting quality Ghanaian producers
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-foreground mb-4 leading-relaxed">
                Supply & Demand Worldwide Limited is a legally registered
                limited liability company in Ghana, established in 2013. With
                over a decade of trading experience, we specialize in exporting
                traditional West African staple foods to global markets through
                our flagship BorgaFoods brand.
              </p>
              <p className="text-lg text-foreground mb-4 leading-relaxed">
                We operate international trading activities with operational
                presence in both Ghana (Tema) and China (Hangzhou), allowing us
                to bridge African production with international market
                expectations.
              </p>
              <p className="text-lg text-foreground mb-6 leading-relaxed">
                With over a decade of trading experience, we serve
            ...
            {[
              {
                ...
                title: "Sourcing",
                description:
                  "Direct relationships with quality producers across Ghana",
              },
              {
                step: "2",
                title: "Production",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Operations in Ghana and China. Strategic positioning for both supply and market access.",
              },
            ].map(item => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8">
              ...
              <p className="text-foreground mb-4">
                We believe in clear, honest communication. No hidden costs, no
                exaggerated claims. You know exactly what you're getting.
              </p>
            ...
            <Card className="p-8">
              ...
              <p className="text-foreground mb-4">
                We're not interested in one-off transactions. We build lasting
                relationships with our partners based on trust and mutual
                success.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-foreground">
            ...
            <Card className="p-8">
              ...
              <p className="text-foreground mb-4">
                Your success is our success. We invest in understanding your
                market and helping you grow your business.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-foreground">
                  <CheckCircle
      ...
      <section className="py-16 bg-primary">
        <div className="container text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-white/90">
            Let's discuss how we can support your import business with quality
            Ghanaian products.
          </p>
          <Button
            size="lg"
