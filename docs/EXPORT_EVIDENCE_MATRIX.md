...
| - | --- | --- | --- | --- |
| 1 | Supply and Demand Worldwide Limited is a GEPA-registered commercial exporter | GEPA Certificate of Exporter Registration, Reg. No. GEPA2018800113 (2018) | **Not yet** — pending renewal confirmation | See `docs/GEPA_CREDIBILITY_SECTION_PROPOSAL.md` for the two ready options, held pending confirmation |
